...
const struct game thegame = {
    "Slant","L:A_N:application_PC:T_ID:com.kbarni.slant", "Fill in a diagonal line in every grid square so that there are no loops in the grid, \
    and so that every numbered point has that many lines meeting at it.\nTap on a square to cycle it between \, / and empty. ",
