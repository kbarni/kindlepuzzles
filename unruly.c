...
const struct game thegame = {
    "Unruly","L:A_N:application_PC:T_ID:com.kbarni.unruly", " Colour every square either black or white, in such a way that:\n\
    1.no three consecutive squares, horizontally or vertically, are the same colour\n2.ach row and column contains the same number of black and white squares.\n\
    Tap on an empty square to cycle it between black and white and empty.",
