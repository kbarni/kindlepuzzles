...
const struct game thegame = {
    "Loopy","L:A_N:application_PC:T_ID:com.kbarni.loopy", "Form a single closed loop out of the grid edges, in such a way that every \
    numbered square has exactly that many of its edges included in the loop.\nClick on a grid edge to mark it as part of the loop (black), \
    and again to return to marking it as undecided (yellow).\nWhen you have mastered the square grid, look in the Type menu for many other types of tiling! ",
