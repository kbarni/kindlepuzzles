...
const struct game thegame = {
    "Sixteen","L:A_N:application_PC:T_ID:com.kbarni.sixteen", " Slide the grid squares around so that the numbers end up in consecutive order \
    from the top left corner.\nClick on the arrows at the edges of the grid to move a row or column left, right, up or down. The square that \
    falls off the end of the row comes back on the other end. ",
