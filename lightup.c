...
const struct game thegame = {
    "lightup", "L:A_N:application_PC:T_ID:com.kbarni.galaxies", " Place light bulbs in the grid so as to light up all the blank squares. \
    A light illuminates its own square and all the squares in the same row or column unless blocked by walls (black squares). Lights may \
    not illuminate each other. Each numbered square must be orthogonally adjacent to exactly the given number of lights.\nClick on a square \
    to place or remove a light. Right-click to place a dot indicating that you think there is no light in that square. ",
