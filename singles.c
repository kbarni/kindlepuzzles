...
const struct game thegame = {
    "Singles","L:A_N:application_PC:T_ID:com.kbarni.singles", "Black out some of the squares, in such a way that:\n\
    1. no number appears twice in any row or column\n2. no two black squares are adjacent\n3. the white squares form \
    a single connected group (connections along diagonals do not count).\nClick in a square to black it out, and again to uncover it.",
