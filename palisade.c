...
const struct game thegame = {
    "Palisade","L:A_N:application_PC:T_ID:com.kbarni.palisade", "Draw lines along the grid edges, in such a way that the grid is divided into connected \
    regions, all of the size shown in the status line. Also, each square containing a number should have that many of its edges drawn in.\n\
