...
const struct game thegame = {
    "Signpost","L:A_N:application_PC:T_ID:com.kbarni.signpost", "Connect all the squares together into a sequence, so that every square's \
    arrow points towards the square that follows it (though the next square can be any distance away in that direction).\nLeft-drag from a \
    square to the square that should follow it, or right-drag from a square to the square that should precede it.\nLeft-drag a square off the grid to break all links to it. ",
