...
const struct game thegame = {
    "Flood","L:A_N:application_PC:T_ID:com.kbarni.flood", "Try to get the whole grid to be the same colour within the given number of moves, \
    by repeatedly flood-filling the top left corner in different colours.\nClick in a square to flood-fill the top left corner with that square's colour. ",
