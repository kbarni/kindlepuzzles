...
const struct game thegame = {
    "Flip","L:A_N:application_PC:T_ID:com.kbarni.flip", "Try to light up all the squares in the grid by flipping combinations of them.\n\
        ...
        Select one of the 'Random' settings from the Type menu for more varied puzzles. ",
